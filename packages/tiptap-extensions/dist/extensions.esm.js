    ...
    /*!
    * tiptap-extensions v1.32.7
    * (c) 2020 überdosis GbR (limited liability)
    * @license MIT
    */
  
import { Node, getParagraphNodeAttrs, getParagraphDOM, Plugin, PluginKey, ALIGN_PATTERN, Mark, Extension } from 'tiptap';
import { toggleWrap, wrappingInputRule, toggleList, toggleBlockType, setBlockType, textblockTypeInputRule, chainCommands, exitCode, nodeInputRule, splitListItem, sinkListItem, liftListItem, insertText, replaceText, splitToDefaultListItem, toggleMark, markInputRule, markPasteRule, updateMark, removeMark, pasteRule, setTextAlignment } from 'tiptap-commands';
